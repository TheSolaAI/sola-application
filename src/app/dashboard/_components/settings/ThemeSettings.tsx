...
export const ThemeSettings = forwardRef<ThemeSettingsRef>((_, ref) => {
  /**
   * Global State
   */
  const {
  ...
  }, [availableThemes, getCustomThemes, theme]);
    ...
    reader.onload = (e) => {
      try {
        ...
        if (missingProps.length === 0) {
          ...
          toast.error(`Invalid theme file: missing ${missingProps.join(', ')}`);
        }
      } catch (error) {
        toast.error('Invalid theme file format ' + error);
      }
    };
      ...
      <div className="w-full p-4 hidden md:flex md:flex-col items-center overflow-x-auto">
        ...
        >
          ...
          >
            ...
            >
              <div className="p-2">
                <h1 className="text-textColor font-medium text-xs">Sola AI</h1>
