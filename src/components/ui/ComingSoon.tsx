function ComingSoon() {
  return (
    <div className="min-h-screen from-gray-100 to-gray-200 flex flex-col justify-center items-center dark:bg-darkalign">
      <div className="bg-white p-12 rounded-2xl shadow-xl w-96 max-w-md text-center dark:bg-darkalign2">
        ...
        <h2 className="text-3xl font-bold text-gray-800 mb-4 tracking-tight dark:text-bodydark2">
          Coming Soon!
        </h2>
