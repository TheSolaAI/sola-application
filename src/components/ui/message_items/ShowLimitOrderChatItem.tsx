...
import { BorderGlowButton } from '../buttons/BorderGlow.tsx';
  ...
  return (
    <BaseGridChatItem col={3}>
      {props.data.orders.map((order, lIndex) => {
        ...
        return (
          <div key={lIndex} className="bg-sec_background rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow duration-200">
            <div className="flex justify-between items-start">
              <h3 className="font-medium text-base">
                Order ID: <span className="font-mono">{order.order_id.slice(0, 4)}...
                {order.order_id.slice(-5)}</span>
              </h3>
