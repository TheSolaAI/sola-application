  ...
  useEffect(() => {
    ...
    const checkStatus = async () => {
      try {
        ...
        attempts++;
        const txInfo = await connection.getTransaction(props.txn, {"maxSupportedTransactionVersion": 0, commitment: 'confirmed'});
              ...
              {statusInfo.isLoading ? (
                ...
                <>
                  ...
                  <span className={`text-sm font-medium ${
                    ...
                    txStatus === 'failed' ? 'text-red-500' : 'text-bodydark2'
                  }`}>
                    {statusInfo.label}
                  </span>
                </>
