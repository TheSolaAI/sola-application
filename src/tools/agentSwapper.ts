...
const functionDescription =
  "Use this function when the current user request cannot be fulfilled by the current tools that you have. Only call this function if the user's request falls within the context of the agents you support. Do not call this function if the user request falls outside of the agent contexts you possess.";
